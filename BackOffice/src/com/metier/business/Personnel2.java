...
public class Personnel2 {
	...
	public Personnel2(String matricule, String nom, String prenom, String date, String date2, String motPasse) {
		Matricule = matricule;
		this.nom = nom;
		this.prenom = prenom;
	...
	public Personnel2(String matricule, String nom, String prenom) {
		Matricule = matricule;
		this.nom = nom;
		this.prenom = prenom;
	}
