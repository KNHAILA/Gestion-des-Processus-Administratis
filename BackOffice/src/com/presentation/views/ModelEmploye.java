...
public class ModelEmploye extends AbstractTableModel {
	...
	private String s[]= {"nom","prenom","numero","Date de naissance","Date d'ambauche","Service","Chef"};
	
	public ModelEmploye(ArrayList<Employe> lesEtudiants) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 3: return e.getDateEmbauche();
		case 4: return e.getDateNaissance();
