...
import com.presentationRepo.controleurs.Accueil1Controleur;
...
public class Accueil1 extends JFrame {
	...
	private Accueil1Controleur controleur;
	...
	private void initialiser() {
		...
		ImageIcon i = new ImageIcon("icons/one.png");
		Image m = i.getImage();
		Image n = m.getScaledInstance(120, 120, java.awt.Image.SCALE_SMOOTH);
		i=new ImageIcon(n);
		consult=new JLabel("Par");
		consult1=new JLabel("Procedure");
		controleur=new Accueil1Controleur();
		controleur.setAccueil1(this);
	...
	private void caret() {		
		caret.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent a) {
				Accueil1.this.controleur.acceder3();
			}
		});
	}
	...
	public Accueil1Controleur getControleur() {
		return controleur;
	}

	public void setControleur(Accueil1Controleur controleur) {
